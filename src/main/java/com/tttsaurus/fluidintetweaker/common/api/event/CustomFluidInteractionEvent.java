...
public class CustomFluidInteractionEvent extends WorldEvent
{
    ...
    public CustomFluidInteractionEvent(World world, BlockPos pos, boolean isFluidAboveAndBelowCase, IBlockState blockStateBeforeInteraction, InteractionIngredient ingredientA, InteractionIngredient ingredientB, ComplexOutput complexOutput)
    {
        super(world);
        this.pos = pos;
        ...
        this.delegate = complexOutput.getOutputDelegate(world, pos);
    }
}
